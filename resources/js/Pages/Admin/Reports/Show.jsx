...
export default function AdminReportShow({ report, statusOptions }) {
    ...
    const canOpenEvidenceCapsule = ['diverifikasi', 'selesai'].includes(report.status?.slug);
                ...
                <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <div className="space-y-6">
                        <Card className="space-y-4">
                            ...
                            {canOpenEvidenceCapsule && (
                                <div className="rounded-soft border border-indigo-100 bg-indigo-50 px-4 py-4">
                                    <a
                                        href={route('evidence.capsule', report.report_code)}
                                        target="_blank"
                                    ...
                                    <p className="mt-2 text-xs leading-6 text-indigo-700">
                                        Tautan ini membuka halaman publik Kapsul Bukti
                                        Administratif untuk laporan yang sudah diverifikasi atau
                                        selesai.
                                    </p>
                                </div>
                            )}
                        ...
                        <form onSubmit={submit} className="app-panel space-y-5 p-5 sm:p-6">
                            ...
                            <div>
                                <InputLabel
                                    ...
                                    value="Catatan Penyelesaian (opsional)"
                                />
                                <textarea
                                    id="resolution_note"
                            ...
                            <div>
                                ...
                                <InputError
                                    className="mt-2"
                                    message={errors.resolution_photos}
                                />
                                <InputError
                                    className="mt-2"
                                    message={errors['resolution_photos.0']}
                                />
                            </div>
                            <div className="rounded-soft border border-amber-100 bg-amber-50 px-4 py-4 text-sm leading-7 text-amber-800">
                                Gunakan status ini sebagai indikator proses penanganan dan
                                koordinasi. Bila status diubah menjadi selesai, sebaiknya disertai
                                catatan dan bukti penyelesaian agar closed-loop reporting tetap
                                kuat.
                            </div>
