...
export default function AdminPatrolHistoryIndex({ historyByDate = [] }) {
    return (
        <AuthenticatedLayout
            header={
                <div>
                    ...
                    <p className="body-copy">
                        Lihat histori checklist patroli per tanggal dari seluruh titik yang sudah didaftarkan.
                    </p>
                </div>
            }
        >
            <Head title="Riwayat Patroli" />
