...
export default function PekasehReportsIndex({ reports, filters, filterOptions, summary, scope }) {
    const updateFilter = (key, value) => {
        router.get(route('pekaseh.reports.index'), {
            ...filters,
            [key]: value,
        }, {
            preserveState: true,
    ...
    return (
            ...
            header={
                <div>
                    ...
                    <p className="body-copy">
                        Pantau seluruh laporan yang masuk pada Subak Anda dan buka detail untuk verifikasi lanjutan.
                    </p>
                    {scope?.subak_name && (
        ...
        >
            <Head title="Semua Laporan Pekaseh" />
            ...
            <div className="app-page">
                ...
                <section className="app-panel overflow-hidden">
                    <div className="border-b border-neutral-200 px-6 py-5">
                        <h3 className="section-title text-xl">Daftar laporan Subak</h3>
                    </div>
                    {reports.length > 0 ? (
                        ...
                        <div className="px-6 py-12 text-center text-neutral-500">
                            Tidak ada laporan pada Subak Anda yang cocok dengan filter saat ini.
                        </div>
                    )}
                </section>
                ...
                <section className="space-y-4">
                    <div>
                        <h3 className="section-title text-xl">Peta monitoring Subak</h3>
                        <p className="mt-2 text-sm text-neutral-500">
                            Marker ringkas dari laporan dalam wilayah Subak Anda untuk pembacaan cepat di lapangan.
                        </p>
                    </div>
                    <LeafletMap
                        markers={markers}
